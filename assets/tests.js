...
define('client/tests/components/primary-view.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint | components/primary-view.js');
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(false, 'components/primary-view.js should pass jshint.\ncomponents/primary-view.js: line 4054, col 80, A leading decimal point can be confused with a dot: \'.825\'.\ncomponents/primary-view.js: line 3920, col 23, Misleading line break before \'+\'; readers may interpret this as an expression boundary.\ncomponents/primary-view.js: line 3923, col 10, Misleading line break before \'&&\'; readers may interpret this as an expression boundary.\ncomponents/primary-view.js: line 4058, col 17, Expected \'{\' and instead saw \'url\'.\ncomponents/primary-view.js: line 4062, col 21, Expected \'{\' and instead saw \'return\'.\ncomponents/primary-view.js: line 4063, col 24, Expected \'{\' and instead saw \'return\'.\ncomponents/primary-view.js: line 4108, col 32, Missing semicolon.\ncomponents/primary-view.js: line 4118, col 15, Missing semicolon.\n\n8 errors');
  });
});
...
define('client/tests/integration/components/primary-view-test', ['exports', 'ember-qunit'], function (exports, _emberQunit) {

  (0, _emberQunit.moduleForComponent)('primary-view', 'Integration | Component | primary view', {
    integration: true
  });
  ...
  (0, _emberQunit.test)('it renders', function (assert) {
    ...
    this.render(Ember.HTMLBars.template((function () {
      return {
        ...
        statements: [['content', 'primary-view', ['loc', [null, [1, 0], [1, 16]]], 0, 0, 0, 0]],
        locals: [],
        templates: []
      };
    })()));
    ...
    this.render(Ember.HTMLBars.template((function () {
      ...
      return {
        ...
        statements: [['block', 'primary-view', [], [], 0, null, ['loc', [null, [2, 4], [4, 21]]]]],
        locals: [],
        templates: [child0]
      };
    })()));
...
define('client/tests/integration/components/primary-view-test.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint | integration/components/primary-view-test.js');
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/primary-view-test.js should pass jshint.');
  });
});
...
define('client/tests/unit/routes/league-of-legends-test', ['exports', 'ember-qunit'], function (exports, _emberQunit) {

  (0, _emberQunit.moduleFor)('route:league-of-legends', 'Unit | Route | league of legends', {
    // Specify the other units that are required for this test.
    // needs: ['controller:foo']
  });
...
define('client/tests/unit/routes/league-of-legends-test.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint | unit/routes/league-of-legends-test.js');
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/routes/league-of-legends-test.js should pass jshint.');
  });
});
/* jshint ignore:start */
